...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-02T09:06:13+00:00",
...
- **00. MCP 소개**  
  Model Context Protocol과 AI 파이프라인에서의 중요성 개요. [자세히 읽기](./00-Introduction/README.md)
- **01. 핵심 개념 설명**  
  MCP 핵심 개념 심층 탐구. [자세히 읽기](./01-CoreConcepts/README.md)
- **02. MCP 보안**  
  보안 위협과 모범 사례. [자세히 읽기](./02-Security/README.md)
- **03. MCP 시작하기**  
  환경 설정, 기본 서버/클라이언트, 통합. [자세히 읽기](./03-GettingStarted/README.md)
</details>
...
- **3.7. AI Toolkit 사용하기** – [가이드](./03-GettingStarted/07-aitk/README.md)
...
<details>
  <summary><strong> 4-5강: 실무 및 고급 주제</strong></summary>

- **04. 실무 구현**  
  SDK, 디버깅, 테스트, 재사용 가능한 프롬프트 템플릿. [자세히 읽기](./04-PracticalImplementation/README.md)
- **05. MCP 고급 주제**  
  멀티모달 AI, 확장, 엔터프라이즈 활용. [자세히 읽기](./05-AdvancedTopics/README.md)
...
### 모델 컨텍스트 프로토콜 모범 사례
<details>
  <summary><strong>레슨 6-9: 커뮤니티, 모범 사례 & 실습</strong></summary>
...
### VScode용 AI 툴킷과 함께하는 모델 컨텍스트 프로토콜 실습
<details>
  <summary><strong>레슨 10: VScode용 AI 툴킷으로 MCP 서버 구축 실습</strong></summary>
    
- **10. AI 워크플로우 간소화: AI 툴킷으로 MCP 서버 구축하기** – [실습](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md)
</details>
...
<details>
  ...
  - [Python 복잡한 구현 예제](../../04-PracticalImplementation/samples/python/mcp_sample.py)
